...
<body>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="../bookController/index">Book Management</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav d-flex justify-content-end">
                    <li class="nav-item">
                        <a class="nav-link" href="#"><?php echo "Xin chào, ".$_SESSION['username'] ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mr-sm-2" href="../loginController/logout">Log out</a>
                    </li>
                </ul>
            </div>
        </nav>
